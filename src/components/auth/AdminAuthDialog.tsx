...
import { adminLogin, adminSignup } from '@/server/actions';
...
export function AdminAuthDialog({ trigger }: AdminAuthDialogProps) {
  ...
  const handleSignup = async (values: SignupFormData) => {
    ...
    if (result.success) {
      toast({ title: 'Signup Successful', description: 'Your admin account has been created. Please log in.' });
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Log in or sign up for an admin account to manage the website.
          </DialogDescription>
        </DialogHeader>
